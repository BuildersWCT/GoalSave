...
async function main() {
    ...
    const CeloSave = await hardhat_1.ethers.getContractFactory("CeloSave");
    console.log("\nDeploying UUPS Proxy and Implementation...");
    const celoSave = await hardhat_1.upgrades.deployProxy(CeloSave, [deployer.address], // Initialize with deployer as admin
    {
        kind: "uups",
